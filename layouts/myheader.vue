<template>
  <div class="header-container">
    ...
    >
      <div class="container">
        <!-- 邮箱登录 #start -->
        <div class="operate-view" v-if="dialogAtrr.showLoginType === 'mail'">
          ...
          <div class="wrapper wechat" style="height: 400px">
            ...
            <div class="bottom wechat" style="margin-top: -80px">
              <div class="mail-container">
                <div class="mail-wrapper" @click="mailLogin()">
                  <span class="iconfont icon"></span>
                </div>
...
const defaultDialogAtrr = {
  showLoginType: "mail", // 控制邮箱登录与微信登录切换

  labelTips: "邮箱账号", // 输入框提示

  inputValue: "", // 输入框绑定对象
  placeholder: "请输入您的邮箱账号", // 输入框placeholder
  ...
  methods: {
    ...
    btnClick() {
      ...
      if (this.dialogAtrr.loginBtn == "获取验证码") {
        this.userInfo.mail = this.dialogAtrr.inputValue;
    ...
    getCodeFun() {
      ...
      if (!regEmail.test(this.userInfo.mail)) {
        this.$message.error("邮箱账号不正确");
        return;
      }
    ...
    timeDown() {
      ...
      this.dialogAtrr.labelTips = "验证码已发送至" + this.userInfo.mail;
    ...
    mailLogin() {
      this.dialogAtrr.showLoginType = "mail";
      this.showLogin();
    },
  },
};
